...
import { dataBiodiversityDs } from '../../hooks/StateSpot';
...
const BiodiversityDashboard = () => {
    ...
    //submit data
    const dataBio = dataBiodiversityDs.useState((s) => s)
           ...
           <div className=" items-center justify-center rounded bg-gray-200 p-3">         
                ...
                <div class="grid grid-flow-col gap-4">
                        ...
                        <div className="row-span-2 col-span-2">
                            <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">
                                keterangan Biodiversity</label>
                            <textarea rows="4" 
                            onChange={(e) => setValueInput({...valueInput, deskripsi : e.target.value})}
                            className="block p-2.5 w-full text-sm text-gray-900 dark:bg-gray-300 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan keterangan Biodiversity"/>
